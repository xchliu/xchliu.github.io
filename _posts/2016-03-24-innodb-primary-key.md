...
- [物理结构](http://xchliu.github.io/2016/03/31/The-physical-structure-of-InnoDB-index-pages/)
...
- 第三方工具，比如pecona toolkit（pt-online-schema-change
，[pt-table-checksum](https://www.percona.com/doc/percona-toolkit/2.2/pt-table-checksum.html)）

- 高可用架构对显式定义主键的依赖：[Percona XtraDB Cluster](https://www.percona.com/software/mysql-database/percona-xtradb-cluster)
...
- 所有的二级索引存放的是所依赖的主键信息，主键大小直接影响二级索引的大小。 

- 主键的空间占用：int < 隐藏主键 < bigint < 自定义

- InnoDB 使用主键来作为cluster index来形成整个索引树，单调递增的整数在b+ tree的形成，遍历，分裂，性能最优。需要注意的是，int 和bigint都是有限的取值域。
...
关于隐藏主键：[How does InnoDB behave without a Primary Key?](http://blog.jcole.us/2013/05/02/how-does-innodb-behave-without-a-primary-key/)

长主键： [Long PRIMARY KEY for Innodb tables](https://www.percona.com/blog/2006/10/03/long-primary-key-for-innodb-tables/)
